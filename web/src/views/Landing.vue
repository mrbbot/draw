<template>
  <FullHeight class="landing">
    <div class="container is-small">
      <div
        class="field has-text-centered for-icon has-secondary-rainbow is-hidden-mobile"
      >
        <FontAwesomeIcon
      ...
      <div class="field">
        <div class="control">
          <a
            class="button is-dark has-background-rainbow is-fullwidth"
      ...
      <div class="field is-hidden-mobile">
        <div class="control">
          <router-link class="button is-fullwidth" to="/host"
    ...
    <div class="message-wrapper">
      <transition name="message">
        <div
          class="container is-small has-background-rainbow has-text-white"
          v-if="messageText"
          @click="messageText = ''"
        >
          <span v-if="messageIcon" class="for-icon"
            ><FontAwesomeIcon :icon="['fas', messageIcon]" size="lg"
          /></span>
